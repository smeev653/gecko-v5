...
NCountry = {
	...
	CORE_HAD_PERMANENT_CLAIM = 0.20,						-- Impacts MODIFIER_CORE_CREATION
...
NMilitary = {
	...
	CREATE_CAWA_MIL_COST = 4,						-- Cost to create Cawa (per unit)
...
NAI = {
	...
	MAX_CAV_PERCENTAGE = 40, -- For modding, actual ratio is dynamically computed but will be no higher than this.
	...
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 1, -- The higher this number is, the less willing the AI will be to exceed forcelimits
