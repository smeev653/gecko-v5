...
NDiplomacy = {
	...
	TRIBUTE_BASE_ADM = 0.06,						-- Tributary State: Part Adm tribute, mulitplied by total development
	TRIBUTE_BASE_DIP = 0.06,						-- Tributary State: Part Dip tribute, mulitplied by total development
	TRIBUTE_BASE_MIL = 0.06,						-- Tributary State: Base Mil tribute, mulitplied by total development
...
NAI = {
	...
	PEACE_WAR_DIRECTION_FACTOR = 0, -- AI willingness to peace based on who's making gains in the war
	...
	PEACE_CAPITAL_FACTOR = 15, -- AI unwillingness to peace based on holding their own capital
