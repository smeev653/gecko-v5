...
NDiplomacy = {
	...
	MIN_MONTHLY_COST_FOR_INFLUENCE_NATION = 2.084,
	...
	VASSALIZE_BASE_DEVELOPMENT_CAP = 300, 			-- Countries with more total development than this cannot be vassalized
	...
	REVANCHISM_MONTHLY_DECAY = 0.4165,			-- about 20 years to decay all of it.
	...
	PEACE_COST_GOLD_STEP = 4, 						-- _DDEF_PEACE_COST_GOLD_STEP_ Peace Cost for 1 loan size gold of giver
	...
	PEACE_COST_WAR_REPARATIONS = 5,				-- Peace cost for war reparations
	...
	PEACE_COST_DEMAND_NON_OCCUPIED_PROVINCE_MULT = 1,
	...
	STABHIT_FOR_BREAKING_ALLIANCE_IN_WAR = 5,
	...
	MINIMUM_TRADE_POWER_TO_PREVENT_PRIVATEER = 0.1, -- Minimum trade power needed for a country that won a war to block privateer from the country that lost the war
	...
	REMOVE_ELECTORATE_INFLUENCE_COST = 0,			-- The amount of IA Remove Electorate costs.
	...
	FORCE_BREAK_ALLIANCE_TRUCE_YEARS = 0,			-- Length of truce imposed by Break Alliance.
	...
	TRIBUTE_BASE_CASH = 0,						-- Tributary State: Part of yearly income given in tribute
	TRIBUTE_BASE_ADM = 0.12,						-- Tributary State: Part Adm tribute, mulitplied by total development
	TRIBUTE_BASE_DIP = 0.12,						-- Tributary State: Part Dip tribute, mulitplied by total development
	TRIBUTE_BASE_MIL = 0.12,						-- Tributary State: Base Mil tribute, mulitplied by total development
	TRIBUTE_MAX_MONARCH_POWER = 12.0,				-- Tributary State: Max Adm/Dip/Mil per Tributary
	TRIBUTE_BASE_MANPOWER = 0.375,					-- Tributary State: Part of yearly manpower given in tribute
	TRIBUTE_SENT_TRUST = 5,							-- Tributary State: Bilateral Trust if tribute sent
...
NCountry = {
	...
	PROSPERITY_INCREASE_SIZE= 2,				-- if diceroll of d20< monarch stat, while possible ot increase
	...
	NEW_HEIR_LEGITIMACY_HIT = 0,
	NEW_HEIR_LEGITIMACY_THRESHOLD = 0,
	...
	MIN_PRESTIGE_FOR_GOV_RANK_2 = 1,			-- Required prestige to to upgrade to government rank 2
	MIN_PRESTIGE_FOR_GOV_RANK_3 = 25,			-- Required prestige to to upgrade to government rank 3
	...
	MIN_TECH_FOR_CIRCUMNAVIGATE = 32,			-- Must have this level of dip tech to circumnavigate the globe
	...
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 100.0,		-- Promote advisor cost in monthly salaries
	...
	CONVERSION_COOLDOWN_SECONDARY = 0,			-- months before you can convert secondary religion again.
	...
	PS_MOVE_CAPITAL_DISTANCE_CAP = 0,				-- How much this penalty is allowed to cost in Adm.
	...
	PS_IMPROVE_PROVINCE_CAPITAL_DISCOUNT = 0.01,
	...
	STRENGTHEN_GOVERNMENT_LEGITIMACY = 20,
	...
	CORE_HAD_PERMANENT_CLAIM = 0.15,						-- Impacts MODIFIER_CORE_CREATION
	...
	PROVOKE_REVOLT_MIN_PROGRESS = 30.0,	-- Minimum revolt progress to use provoke
	UNREST_DECAY = 1.0,
	...
	PROVINCE_DISCOVERY_YEARS_TECHNOLOGY = 25,		-- Years until discoveries spread within technology group
	...
	ANCESTOR_COST = 200,							-- Cost to integrate an ancestor into the faith.
	INITIAL_REGULAR_COLONY = 10,
	REGULAR_COLONY_GROWTH = 55,
	COLONIAL_CLAIM_BONUS = 20,
	...
	STARTING_FLEET_SIZE = 0.25, 						-- Starting fleet (as percentage of forcelimits)
	...
	LIBERTY_DESIRE_WAR_EXHAUSTION = 0,				-- Liberty desire from overlord's war exhaustion (per WE)
	LIBERTY_DESIRE_MERCANTILISM = 0,				-- Liberty desire from overlord's mercantilism (per Merc).
	...
	LIBERTY_DESIRE_HISTORICAL_RIVAL = 0,			-- Liberty desire from being historical rivals
	...
	NORMAL_ELECTION_CYCLE = 5,						-- The normal election cycle at which 10 republican tradition is lost from 1 unit of scaled republican tradition
	...
	RELATIVE_ON_THRONE_NOT_REGENCY_LIBERTY = 15,
	...
	PROMOTE_INVESTMENTS_TRADEPOWER = 0,
	PROMOTE_INVESTMENTS_INFLATION = 0,
	SCUTAGE_TAX_FRACTION = 0.25,
	--PERCENTAGE_OF_DEV_FOR_CONVERT_TRIBUTARY_TO_VASSAL = 0.4,
	--MAX_LIBERTY_DESIRE_FOR_CONVERT_TRIBUTARY_TO_VASSAL = 50,
	CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0.1,
	...
	RAZE_PROVINCE_POWER_PER_DEVELOPMENT = 0,
	...
	HORDE_UNITY_PER_LOOT = 0.5,					-- Horde unity gained per ducat looted.
	HORDE_UNITY_PER_RAZE = 0.5,						-- Horde unity gained per development level razed.
	PILLAGE_CAPITAL_MAX_DEV_PILLAGED = 6,
	...
	SETTLMENT_GROWTH_CHANCE_MULTIPLIER = 2, -- Affects chance of development increase per year if a colonist is working on Settlement Growth.
...
NEconomy = {
	...
	DECREASE_AUTONOMY_STEP = -20,
	DECREASE_AUTONOMY_MIN = 0,
	INCREASE_AUTONOMY_STEP = 20,
	...
	TRADE_ADDED_VALUE_MODIFER = 0.025,
	TRADE_PROPAGATE_DIVIDER = 25,
...
NMilitary = {
	...
	MARINE_SHOCK_DAMAGE_TAKEN = -0.15,
	MAX_SAILOR_LACK_ATTRITION = 1,
	SAILOR_MAINTAINANCE = 0.02,		-- of build cost.
	BANNER_DISCIPLINE_BONUS = 0.05,
	BANNER_MANPOWER_USAGE = 1,
	BANNER_REINFORCE_SPEED = 1,
	BANNER_MAINTENANCE_COST = 1,
	BANNER_AGE_MULTIPLIER = 0.50,
	BANNER_STARTING_STRENGTH = 1,					-- Starting strength of a banner regiment, 1.0 being full strength
	CAWA_STARTING_STRENGTH = 1,					-- Starting strength of a cawa regiment, 1.0 being full strength
	CAWA_STARTING_MORALE = 0.25,						-- Starting morale of a cawa regiment, 1.0 being full strength
	FORT_DEVASTATION_IMPACT = -10,					-- multiplied by fortlevel/max fortlevel in area per year.
	REVANCHISM_DEVASTATION_IMPACT = -0.1,			-- 100 revanschism is -2 a year.
	...
	GARRISON_SIZE = 3000, 							-- GARRISON_SIZE
	SIEGE_FORCE_NEEDED_MULTIPLIER =  0.334,				-- x times garrison to be able to siege.
	MAX_BREACH = 1,
	...
	TRANSPORT_SHIP_SAILORS_COST = 20,				-- 1 = 1 men in cost.
	...
	MERCENARY_REINFORCE_COST_MULTIPLIER = 0.25,			-- Mercs no longer costs anything to reinfroce
	MERCENARY_BASE_COST = 10.0,					-- base cost added for a mercenary regiment
	TRADITION_GAIN_LAND = 25,						-- Tradition gain base value from land combat.
	TRADITION_GAIN_NAVAL = 40,						-- Tradition gain base value from naval combat.
	CONDOTTIERI_TRADITION_BONUS = 1,				-- This modifies army tradition gained from fighting with condottieris
	...
	REBEL_TRADITION_GAIN = 1, 					-- _MDEF_REBEL_TRADITION_GAIN_; Factor of army/navy tradition gained from fighting rebels and pirates.
	NOMAD_LOOT_TRADITION = 0,	 				-- _MDEF_NOMAD_LOOT_TRADITION_;Military tradition a horde gets from looting territory
	...
	MORALE_RECOVERY_SPEED = 0.125,					-- How much (by percentage) of the maximum morale that the current morale will be recovered with at a time
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 1.67,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	...
	WAR_ENTHUSIASM_HIGH_THRESHOLD = -15,			-- desire for peace must be less than this for high war enthuasiasm
	...
	DAYS_PER_PHASE = 2,								-- How many days each fire and shock phase lasts
	...
	REBEL_LEADER_POWER = 10,							-- The higher this value, the more pips rebel leaders will have on average
	...
	PRESTIGE_TO_TRIBAL_ALLEGIANCE_FACTOR = 6,	-- Multiplied with gained prestige when handing out tribal allegience in a battle
	...
	FORT_FLIPPING_TIME = 15,					-- Number of days it takes an influencing fort to revert the control of a province if left unhindered.
	...
	MAX_DRILL_DECAY = 0.75,							-- Drill can never Decay with more than this value.
	...
	JANISSARIES_USES_CONSTRUCTION = 1,
	...
	FLAGSHIP_REQUIRED_NAVY_SIZE_IN_SAILORS = 750,	-- The number of sailors employed in the navy required to unlock the flagship
	...
	MERCENARY_COMPANY_HIRED_MANPOWER_RECOVERY_MOD = 1,		-- How much to modify the length for manpower recovery if they are hired
	...
	MERCENARY_COMPANY_ARMY_TRADITION = 15.0,		-- At what army tradition mercenaries leaders are generated on.
	...
	SIEGE_BONUS_FOOD_SHORTAGE = 1,
	SIEGE_BONUS_WATER_SHORTAGE = 1,
	SIEGE_BONUS_DEFENDERS_DESERT = 1,
},
...
NAI = {
	...
	ACCEPTABLE_FRACTION_OF_INTEREST_PAYMENTS = 0.4, --of income
	...
	ACCEPTABLE_BALANCE_DEFAULT = 1.05, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	...
	DEVELOP_IN_SUBJECTS_PREFERENCE = 1, -- At 1, AI likes developing subjects approximately the same as its own provinces (more or less depending on their Liberty Desire).
	...
	FORT_MAINTENANCE_CHEAT = 0, -- Set to 0 to disable AI fort maintenance cheating. Warning: Will make in vanilla, but no longer
	...
	AI_BUY_PROVINCE_SUBJECT_MAX_OE = 150, -- % of OE (including OE from sold province) above which AI who is a subject will not buy non-core provinces (Not used if OE is at 0)
	SUBSIDY_YEARS = -1, -- Years AI will give subsidies for
	MIN_INCOME_FOR_SUBSIDIES = -1, -- Minimum monthly income for AI to want to spend some on subsidies
	PS_SHORT_TERM_POOL = 175, -- Max power AI will store in its short-term spending pool
	AGGRESSIVENESS = 5000, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	AGGRESSIVENESS_BONUS_EASY_WAR = 1250, -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 13, -- Tech level at which AI will double its artillery fraction
	TRANSPORT_FRACTION = -1, -- Max fraction of naval forcelimit that should be transports
	INCOME_SAVINGS_FRACTION = -1, -- AI will reserve this amount of their surplus for long-term savings
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 0.001, -- The higher this number is, the less willing the AI will be to exceed forcelimits
	MILITARISE_FORT_BUDGET_FACTOR = 0.1, --if the country should militarise, multiply fort budget priority by this
	DESIRED_SURPLUS = 0.01, -- AI will aim for having at least this fraction of their income as surplus when they don't have large savings
	DESIRED_DEFICIT = 0.01, -- AI will try to spend this fraction of their money above their target for long term savings.
	EXTRA_SURPLUS_WHEN_NEEDING_BUILDINGS = 0.05, -- AI will aim for having at least this fraction of their income as additional surplus when they need buildings
	MAX_SAVINGS = -1, -- AI will keep a maximum of this * their monthly income in long-term savings
	ADVISOR_BUDGET_FRACTION = 0.9, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	--ADVISOR_BUDGET_FRACTION_MAX = 0.5, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	--ADVISOR_BUDGET_FRACTION_MIN = 0.33, -- AI will spend a minimum of this fraction of monthly income on advisor maintenance
	...
	REGIMENTS_PER_GENERAL = 24, -- AI will want one general for every this number of regiments (will not exceed free leader pool)
	...
	DIPLOMATIC_INTEREST_DISTANCE = 175, -- If border distance is greater than this, diplomatic AI will have less interest in the country
	CONQUEST_INTEREST_DISTANCE = 135, -- Beyond this range, AI is less interested in conquest of provinces
	...
	PURSUE_DISTANCE = 90, -- AI will not pursue armies retreating to a province further away than this
	...
	PEACE_FORCE_BALANCE_FACTOR = 0, -- AI willingness to peace based on strength estimation of both sides
	...
	PEACE_WARGOAL_FACTOR = 0.5, -- AI unwillingness to peace based on holding the wargoal
	PEACE_CAPITAL_FACTOR = 20, -- AI unwillingness to peace based on holding their own capital
	...
	PEACE_ALLY_WARGOAL_MULT = 2, -- Multiplies PEACE_WARGOAL_FACTOR for allies in a war
	PEACE_ALLY_CAPITAL_MULT = 1, -- Multiplies PEACE_CAPITAL_FACTOR for allies in a war
	...
	PEACE_DESPERATION_FACTOR = 20, -- AI willingness to peace based on desperation from occupied homelands
	...
	PEACE_DESIRE_AI_PREFS_QUICK_PEACE = 50, -- How much AI wants to peace out when player enabled AI setting "Seek Quick Peace"
	PEACE_CALL_FOR_PEACE_FACTOR = 0,	-- How much AI wants peace based on having call for peace
	...
	PEACE_TERMS_PROVINCE_BASE_MULT = 9.0,
	PEACE_TERMS_TRADE_POWER_BASE_MULT = 0.5,
	PEACE_TERMS_HUMILIATE_BASE_MULT = 0.5,
	PEACE_TERMS_REVOKE_CORES_BASE_MULT = 0.75,
	PEACE_TERMS_REVOKE_REFORM_BASE_MULT = 0.75,
	PEACE_TERMS_RETURN_CORES_BASE_MULT =0.75,
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.75,
	PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT = 0.75,
	PEACE_TERMS_RELEASE_ANNEXED_BASE_MULT = 0.5,
	PEACE_TERMS_ANNUL_TREATIES_BASE_MULT = 0.5,
	PEACE_TERMS_GOLD_BASE_MULT = 0.005,
	PEACE_TERMS_GIVE_UP_CLAIM = 0.0,
	PEACE_TERMS_GIVE_UP_CLAIM_PERMANENT = 0.4,
	...
	PEACE_TERMS_PROVINCE_CORE_MULT = 25.0, -- AI desire for a province is multiplied by this if it has a core on it
	PEACE_TERMS_PROVINCE_WARGOAL_MULT = 15.0, -- AI desire for a province is multiplied by this if it is the wargoal
	PEACE_TERMS_PROVINCE_CLAIM_MULT = 10.0, -- AI desire for a province is multiplied by this if it has a claim on it
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 1, -- AI desire for a province is multiplied by this if it is not the same culture
	PEACE_TERMS_PROVINCE_VASSAL_MULT = 2, -- AI desire for a province is multiplied by this if it would go to their vassal instead of themselves
	PEACE_TERMS_PROVINCE_REAL_ADJACENT_MULT = 5, -- AI desire for a province is increased by this multiplier for each owned adjacent province
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 0.4, -- AI desire for a province is multiplied by this if it is not adjacent at all (including vassals and other provinces being taken in peace)
	PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 0.1, -- AI desire for a province is multiplied by this if it is not on their conquest list
	...
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 2.75, -- AI desire for a province is multiplied by this if it has 0% overextension (not applied to cores)
	PEACE_TERMS_PROVINCE_ISOLATED_CAPITAL_MULT = 0.75, -- AI desire for a province if it is capital (costs a bit more to take)
	PEACE_TERMS_PROVINCE_ALLY_MULT = 0.65, -- AI desire for giving (non-core) provinces to its allies
	PEACE_TERMS_PROVINCE_IMPORTANT_ALLY_MULT = 2, -- AI desire for giving provinces to allies that it has promised land
	PEACE_TERMS_TRADE_POWER_VALUE_MULT = 0.65, -- AI desire for transfering trade power is multiplied by this for each 0.1 trade value in shared nodes
	PEACE_TERMS_TRADE_POWER_VALUE_MAX = 2.75, -- Max AI desire for transfering trade power from shared node value
	PEACE_TERMS_TRADE_POWER_NO_TRADE_INTEREST_MULT = 0.5, -- AI desire for transfering trade power is multiplied by this if they are not a merchant republic
	PEACE_TERMS_HUMILIATE_VALUE_MULT = 1, -- AI desire for humiliating is multiplied by this for each 1 prestige the enemy has
	PEACE_TERMS_HUMILIATE_VALUE_MAX = 1.75, -- Max AI desire for humiliating its' enemy
	PEACE_TERMS_REVOKE_CORE_VASSAL_MULT = 0.6, -- AI desire for revoking cores is multiplied by this if the cores are on their vassal instead of themselves
	PEACE_TERMS_REVOKE_CORE_FEAR_MULT = 1.75, -- AI desire for revoking cores is multiplied by this if they are afraid of the other country
	PEACE_TERMS_RETURN_CORES_VASSAL_MULT = 5.0, -- AI desire for returning core provinces is multiplied by this for their vassals
	PEACE_TERMS_RETURN_CORES_NOT_FRIEND_MULT = 0.1, -- AI desire for returning core provinces is multiplied by this if they are not friends of the country core is being returned to
	PEACE_TERMS_RETURN_CORES_IMPERIAL_LIBERATION_MULT = 2.5, --AI desire for returning core province is multiplied by this if it's a target of Imperial Liberation CB war.
	PEACE_TERMS_ANNUL_TREATIES_NO_INTEREST_MULT = 0.1, -- AI desire for annuling a treaty is multiplied by this if they have no strategic interests in doing so
	PEACE_TERMS_PROVINCE_HRE_UNJUSTIFIED_MULT = 0.1, -- AI desire for a province is multiplied by this for HRE provinces if they are a member of the empire and don't have a CB, claim or core to it
	PEACE_TERMS_MIN_MONTHS_OF_GOLD = 5, -- If they don't have at least this much warscore worth of gold, prefer concede defeat
	PEACE_TERMS_PROVINCE_STRATEGY_THRESHOLD = 0.125, -- If province has at least this strategic priority, AI values it higher in peace deals
	PEACE_TERMS_RETURN_PROVINCE_STRATEGY_MULT = 0.35, -- If we have strategic priority on a province, AI desire to release it to another nation is multiplied by this amount
	PEACE_TERMS_EMPEROR_RELEASE_PRINCE = 50.0, -- This is added, not multiplied
	PEACE_TERMS_RELEASE_VASSAL_SIZE_MULT = 0.125, -- AI desire mult for releasing vassal increased by this for each province they hold
	PEACE_TERMS_RELEASE_VASSAL_MAX_MULT = 1.5, -- Max AI desire mult for releasing vassals
	PEACE_TERMS_RELEASE_VASSAL_HRE_MULT = 2.25, -- AI desire for releasing a vassal is multiplied by this if both are HRE members
	...
	PEACE_TERMS_WAR_REPARATIONS_BASE_MULT = 0.2, -- AI desire for war reparations through peace
	PEACE_TERMS_WAR_REPARATIONS_MIN_INCOME_RATIO = 0.9, -- AI only wants war reparations if other country has at least this % of their income
	...
	DIPLOMATIC_ACTION_ALLIANCE_ACCEPTANCE_MULT = 2.25, -- AI scoring for alliance based on willingness to accept it if offered to them
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_BEFRIEND_FACTOR = 190, -- AI scoring for improve relations is increased by this if they have an attitude with 'befriend' desire
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_ALLY_FACTOR = 190, -- AI scoring for improve relations is increased by this if they have an attitude with 'ally' desire
	...
	DIPLOMATIC_ACTION_MILITARY_ACCESS_ENEMY_REGIMENTS_FACTOR = 2.5, -- AI scoring for military access is increased by this for each enemy regiment they are sheltering
 	DIPLOMATIC_ACTION_VASSALIZE_DEVELOPMENT_FACTOR = 100, -- AI scoring for vassalize is increased by this for each development in target's provinces
	...
	DIPLOMATIC_ACTION_CRUSADE_DEVELOPMENT_FACTOR = 10, -- AI scoring for crusade is increased by this for each development in target's provinces
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_BASE_FACTOR = 1000, -- AI scoring for fabricating claims is always increased by this as long as the province is a conquest priority
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_STRATEGY_FACTOR = 2.0, -- AI scoring for fabricating claims based on strategic conquest priorities
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_OTHER_CB_FACTOR = 1.5, -- AI scoring for fabricating claims if they already have another CB usable on the province
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_HRE_FACTOR = 0.0, -- AI scoring for fabricating claims if both parts are HRE
	...
	AI_TOTAL_DEV_CULTURE_MULTIPLIER = 12.5,				-- Multiplier for how much the AI values having much development in accepted cultures.
	...
	INVADING_BRAVERY = 1.275,									-- If (defender strength) / (invader strength) > INVADING_BRAVERY, the AI won't attempt a naval invasion
	INVADING_MAX_AWAY_RATIO = 1.9,							-- AI will never send more than this ratio to invade (Measured in strength)
	...
	DRILLING_BUDGET_OF_SURPLUS = 0.01,							-- Max amount of surplus to be used for drilling
	...
	MIN_FORCE_LIMIT_SHARE_REGION_ASSIGN = 0.125,					-- AI will only assign armies larger that this to a region
	...
	ASSIMILATION_INTEREST_AMOUNT_FACTOR = 1000,					-- Influence on assimilation interest from number of provinces left to conquer
	...
	WAR_MIN_WARSCORE_TO_JOIN = -5,								-- Starting warscore for the AI to join a call for arms
	ARMY_DISTANCE_SCORE_IMPACT = 0.45,							-- Army <-> province distance impact on province evaluation
	BORDER_DISTANCE_SCORE_IMPACT = 9.0,							-- Border <-> province distance impact on province evaluation
	IMPORANT_PROVINCE_THRESHOLD = 0.025,							-- AI will try to defend provinces under threat worth more than this percentage of total development
	REGION_PLANNING_HOMELAND_PRIORIZATION = 20,				-- Homeland priorization when assigning armies to regions (only applied when actually threatened)
	MISSIONARY_MAINTENANCE_SHARE = 0.2,							-- The most an AI will spend of its income on a missionary
	BUY_INDULGENCE_BASE_AI_DESIRE = -1,						-- AI desire for buy indulgence if curia controller has negative opinion of it, multiplied by budget/cost
	...
	DEFENDER_OF_FAITH_BASE_AI_DESIRE = -1,						-- AI scoring for becoming defender of faith, multiplied by budget/cost
	CALL_ECUMENICAL_COUNCIL_BASE_AI_DESIRE = -1,				-- AI scoring for calling ecumenical council, multiplied by budget/cost
...
NAIEconomy = {
	...
	REBEL_THREAT_MILITARIZE_THRESHOLD = 0.5,					-- Above what rebel threat should the AI militarize (i.e. focus spending on armies)
	MILITARY_FOCUS_DEFAULT = 1.5,
	MILITARY_FOCUS_LOWER_BOUND = 1,
	MILITARY_FOCUS_UPPER_BOUND = 2.0,
	ARMY_FRACTION_MILITARIZE = 1.5,
	ARMY_FRACTION_PEACEFUL = 1.5,
	ARMY_FRACTION_MILITARIST = 1.5,
	NAVY_FRACTION_PEACEFUL = 1.25,
	NAVY_FRACTION_CAPITALIST = 1.25,
	FORT_FRACTION_MILITARIZE = 1.33,
	FORT_FRACTION_MILITARIST = 0.3,
	FORT_FRACTION_CAPITALIST = 0.3,
	MISSIONARY_FRACTION = 0.15,
	STATE_MAINTENANCE_FRACTION = 0.1,
	--BASE_SAVINGS_PRIORITY = 0.5,
	--BASE_SAVINGS_PRIORITY_WARTIME = 0.0,
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 1,
	LOAN_REPAYMENT_SAVINGS_PRIORITY_WARTIME = -1,
...
NReligion = {
	...
	CONVERSION_ZEAL_DURATION = 1825,							-- Amount of days in which you cannot convert the province back.
	KARMA_FOR_CONVERSION = 0.1,
	MIN_CARDINALS = 15,											-- Least amount of cardinals/ Starting cardinals
	MAX_CARDINALS = 100,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 20,								-- Max cardinals in a single country
	...
	INVEST_PAPAL_INFLUENCE = 20.0,								-- The amount of papal influence you invest in becoming controller of the curia.
	...
	CHANGE_SECONDARY_PRESTIGE_HIT = 0,
	...
	APPOINT_CARDINAL_INFLUENCE_PAPAL_STATE = 0,			-- Yearly passive influence gained by cardinals in Papal States
...
NGovernment = {
	SELECT_HEIR_FROM_HAREM_AT_MONARCH_AGE = 20, -- The age in years when an heir is selected if the government "has_harem" flag is set.
	...
	FEUDAL_THEOCRACY_INTERACTION_COOLDOWN_YEARS = 10,
	...
	YEARLY_TRIBAL_ALLEGIANCE_MAX = 0,
	TRIBAL_ALLEGIANCE_HUMILIATE = 60.0, -- TA gained from doing Humiliate or Show Strength in a war.
	...
	GOVERNMENT_REFORM_CHANGE_PROGRESS_COST = 25.0,
	GOVERNMENT_REFORM_COST_CENTRALIZE_STATE = 20.0,
