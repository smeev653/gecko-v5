...
NDiplomacy = {
	...
	MAX_PEACE_TREATY_COST = 50,					-- in diplo power
...
NCountry = {
	...
	MAX_CROWN_COLONIES = 9,							-- How many province a country can hold in a colonial region before creating a colonial nation
...
NMilitary = {
	...
	COMBAT_DICE_SIDE = 5,							-- How many sides the dice used in combat has
	...
	MERCENARY_COMPANY_MANPOWER_PER_REGIMENT = 1.25,	-- Manpower reserve factor (multiplied by 1000 per regiment)
...
NAI = {
	...
	STATE_MAINTENANCE_BUDGET_FRACTION = 0.1, -- AI will spend a maximum of this fraction of monthly income on state maintenance
