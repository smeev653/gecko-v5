...
NReligion = {
	...
	MAX_CARDINALS_PER_COUNTRY = 10,								-- Max cardinals in a single country
	...
	CALL_ECUMENICAL_COUNCIL_COST = 1,						-- Cost in years-of-income
	...
	BUY_INDULGENCE_COST = 5,								-- Cost in years-of-income
