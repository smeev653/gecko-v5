...
NMilitary = {
	...
	LEADER_GAIN_PERSONALITY_BASE_CHANCE = 25.0,		-- Base chance in percent for leader to gain a trait after combat (modified by tradition gained)
	...
	CREATE_CAWA_MIL_COST = 7,						-- Cost to create Cawa (per unit)
...
NAI = {
	...
	MILITARISE_FORT_BUDGET_FACTOR = 1, --if the country should militarise, multiply fort budget priority by this
