...
NCountry = {
	...
	TECH_AHEAD_OF_TIME = 0.09,		-- per year ahead.
...
NMilitary = {
	...
	PARTICIPATION_SCORE_MERC_MULT = 1,			-- How much less participation do you get from mercs?
	...
	ARMY_ATTRITION_AT_COAST = 1,					-- How many percent attrition units take while loaded onto ships along the coasts
	...
	COSSACKS_MAXIMUM_RATIO = 1,					-- Maximum number of Cossacks regiments, relative to force limit
	...
	COSSACK_BASE_COST_MODIFIER = 0.9,				-- Cossack base cost is double as expensive
...
NAI = {
	...
	MAX_CAV_PERCENTAGE = 0, -- For modding, actual ratio is dynamically computed but will be no higher than this.
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_BASE_FACTOR = 200, -- AI scoring for fabricating claims is always increased by this as long as the province is a conquest priority
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_STRATEGY_FACTOR = 0.0, -- AI scoring for fabricating claims based on strategic conquest priorities
	...
	AI_TOTAL_DEV_CULTURE_MULTIPLIER = 10,				-- Multiplier for how much the AI values having much development in accepted cultures.
