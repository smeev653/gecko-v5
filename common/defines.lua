...
NAI = {
	...
	MAX_SAVINGS = 0.1, -- AI will keep a maximum of this * their monthly income in long-term savings
...
NAIEconomy = {
	BUDGETING_ADJUSTMENT_STEP = 20,							-- Amount in percent to increase/decrease spending on budget posts when adjusting due to surplus/deficit
