...
NCountry = {
	...
	INNOVATIVENESS_AHEAD_OF_TIME_BONUS = 0.05, -- Bonus for being ahead of time in tech
...
NMilitary = {
	...
	MERCENARY_REINFORCE_COST_MULTIPLIER = 1.25,			-- Mercs no longer costs anything to reinfroce
...
NAI = {
	...
	ADVISOR_BUDGET_FRACTION = 1, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	...
	RECRUIT_ADVISOR_BASE_AI_DESIRE = 100.0,						-- AI scoring for redruiting advisors, multiplied by budget/cost
	...
	ESTATE_MIN_WANTED_CROWNLAND = 11.0,
