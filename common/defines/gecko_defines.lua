...
NDefines.NCountry.PARLIAMENT_BACKING_PERCENTAGE = 70			-- average percent of seats backing an issue (0-100)
...
NDefines.NMilitary.CAVALRY_BREAKTHROUGH = 0.05
NDefines.NMilitary.INFANTRY_BREAKTHROUGH = 0.025
...
NDefines.NEngine.EVENT_PROCESS_OFFSET = 60 