...
NDefines.NMilitary.RESERVE_DAILY_MORALE_DAMAGE = 0.1
NDefines.NMilitary.CREATE_JANISSARIES_MIL_COST = 7
NDefines.NMilitary.CREATE_CAWA_MIL_COST = 10
NDefines.NMilitary.RAJPUT_BASE_COST_MODIFIER = 1.4			-- Rajput base cost is double as expensive
NDefines.NMilitary.COSSACK_BASE_COST_MODIFIER = 1.4
